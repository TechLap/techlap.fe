...
const OrderDetailModal: React.FC<OrderDetailModalProps> = ({
  ...
  const discount = order?.orderDetails.reduce(
    (sum, item) =>
      sum +
      item.product.price *
        ((item.product.discount as number) / 100) *
        item.quantity,
    0
  );
            ...
            <div className="flex items-center space-x-4">
              ...
              >
                <Badge
                  ...
                  variant="solid"
                  color={getStatusOrderColor(order.status)}
                />
              </div>
              <button
                onClick={onClose}
                ...
                <div className="bg-gray-50 rounded-lg p-4 top-6 lg:sticky lg:top-24 lg:h-fit">
                  ...
                  <div className="mt-4 p-3 bg-blue-50 rounded-lg">
                    <p className="text-xs text-blue-800">
                      <strong>Chính sách bảo hành:</strong> Tất cả sản phẩm đều
                      được bảo hành chính hãng 12-24 tháng
                    </p>
                  </div>
                </div>
              </div>
