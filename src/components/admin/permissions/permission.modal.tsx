...
import Access from "../../../pages/auth/route/access"; // thêm dòng này
...
const PermissionModal = (props: IProps) => {
  ...
  const requiredPermissionName = dataInit ? "Update a permission" : "Create a permission"; // thêm
  ...
  return (
    ...
    >
      ...
      <div className="hs-overlay-open:mt-7 hs-overlay-open:opacity-100 hs-overlay-open:duration-500 mt-0 opacity-0 ease-out transition-all md:max-w-lg md:w-full m-3 md:mx-auto">
        <Access permission={{ name: requiredPermissionName }} hideChildren>
                  ...
                  <div>
                    ...
                    {errors.module && (
                      <div className="flex items-center gap-1 mt-1">
                        ...
                        <p className="text-sm text-red-600 font-medium">{errors.module.message}</p>
                      </div>
                    )}
                  </div>
                  ...
                  <div>
                    ...
                    {errors.method && (
                      <div className="flex items-center gap-1 mt-1">
                        ...
                        <p className="text-sm text-red-600 font-medium">{errors.method.message}</p>
                      </div>
                    )}
                  </div>
                </div>
