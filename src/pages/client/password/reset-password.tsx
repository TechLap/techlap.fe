...
import { apiResetPasswordForCustomer } from "../../../config/api";

const ResetPasswordPageForCustomer = () => {
    ...
    const handleChangePassword: SubmitHandler<FormValues> = async (values) => {
        const response = await apiResetPasswordForCustomer(
...
export default ResetPasswordPageForCustomer;