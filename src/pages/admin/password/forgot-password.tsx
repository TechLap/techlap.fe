...
import { apiForgotPasswordForUser } from "../../../config/api";
import { Link } from "react-router-dom";


const ForgotPasswordPageForUser = () => {
    ...
    const handleForgotPassword: SubmitHandler<FormValues> = async (values) => {
        const response = await apiForgotPasswordForUser(
            values.email
        );
        if (response.data) {
            toast.success(
...
export default ForgotPasswordPageForUser;